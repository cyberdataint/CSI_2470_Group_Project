...
public final class answer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function getUserAnswers(userName) {\r\n");
      out.write("            const storedAnswers = localStorage.getItem(\"answers\");\r\n");
      out.write("            if (storedAnswers) {\r\n");
      out.write("                const answers = JSON.parse(storedAnswers);\r\n");
      out.write("                return answers.filter(answer => answer.userName === userName);\r\n");
      out.write("            }\r\n");
      out.write("            return [];\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("            const answers = getUserAnswers(userName);\r\n");
      out.write("            const yesCount = answers.filter(answer => answer.answer === \"Yes\").length;\r\n");
      out.write("            const noCount = answers.filter(answer => answer.answer === \"No\").length;\r\n");
      out.write("            const dontCareCount = answers\r\n");
      ...
      out.write("            const userName = getUserName();\r\n");
      out.write("            const storedAnswers = localStorage.getItem(\"answers\");\r\n");
      out.write("            const answers = storedAnswers ? JSON.parse(storedAnswers) : [];\r\n");
      out.write("\r\n");
